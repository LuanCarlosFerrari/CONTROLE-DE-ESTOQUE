...
export default function DashboardHotel() {
  ...
  const statCards = [
    { label: 'Disponíveis', sublabel: 'agora', value: stats.disponiveis, icon: BedDouble, color: '#34D399', border: 'rgba(52,211,153,0.3)', glow: 'rgba(52,211,153,0.06)' },
    ...
    { label: 'Check-ins',  sublabel: 'hoje',  value: stats.checkins_hoje,  icon: LogIn,     color: 'var(--amber)', border: 'rgba(16,185,129,0.3)', glow: 'rgba(16,185,129,0.06)' },
          ...
          >
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 16 }}>
              <div>
                ...
                <span style={{ fontSize: 11, color: 'var(--text-subtle)' }}>{sublabel}</span>
              </div>
